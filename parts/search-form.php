...
<form role="search" method="get" action="http://localhost/cppmoderno/" class="wp-block-search__button-outside wp-block-search__icon-button wp-block-search">
    <div class="wp-block-search__inside-wrapper ">
        ...
        <button aria-label="Pesquisar" class="wp-block-search__button btn btn-primary has-text-color has-theme-palette1-color has-icon wp-element-button" type="submit">
